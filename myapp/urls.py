...
urlpatterns = [
    ...
    path('adminview_audio_evidence/<id>', views.adminview_audio_evidence),
    path('adminview_biological_evidence/<id>', views.adminview_biological_evidence),
    path('adminview_chemical_evidence/<id>', views.adminview_chemical_evidence),
    path('adminview_digital_evidence/<id>', views.adminview_digital_evidence),
    path('adminview_document_evidence/<id>', views.adminview_document_evidence),
    path('adminview_financial_evidence/<id>', views.adminview_financial_evidence),
    path('adminview_pattern_evidence/<id>', views.adminview_pattern_evidence),
    path('adminview_physical_evidence/<id>', views.adminview_physical_evidence),
    path('adminview_trace_evidence/<id>', views.adminview_trace_evidence),
    # USERS---
    ...
    path('userchangepassword_get/', views.userchangepassword_get),
    path('userchangepassword_post/', views.userchangepassword_post),
